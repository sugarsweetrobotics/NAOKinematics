...
"""
 @file NAOKinematics.py
 @brief NAO Kinematics RT-component
 @date $Date$
...
naokinematics_spec = ["implementation_id", "NAOKinematics", 
		 "type_name",         "NAOKinematics", 
		 "description",       "NAO Kinematics RT-component", 
		 "version",           "1.0.0", 
...
# @brief NAO Kinematics RT-component
# 
# NAO Manipulator Kinematics RT-component. When use this, install
#	nao_kinematics module through pip.
#	To install,
#	#pip install nao_kinematics
# 
# 
class NAOKinematics(OpenRTM_aist.DataFlowComponentBase):
...
def NAOKinematicsInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=naokinematics_spec)
    manager.registerFactory(profile,
                            NAOKinematics,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    NAOKinematicsInit(manager)

    # Create a component
    comp = manager.createComponent("NAOKinematics")
